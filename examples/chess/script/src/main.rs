use monerochan::{include_elf, ProverClient, MONEROCHANProofWithPublicValues, MONEROCHANStdin};
...
fn main() {
    ...
    let deserialized_proof =
        MONEROCHANProofWithPublicValues::load("proof-with-io.bin").expect("loading proof failed");
