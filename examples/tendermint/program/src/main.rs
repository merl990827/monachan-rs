...
pub fn main() {
    ...
    // let light_block_1 = monerochan_runtime::io::read::<LightBlock>();
    // let light_block_2 = monerochan_runtime::io::read::<LightBlock>();

    println!("cycle-tracker-start: io");
    println!("cycle-tracker-start: reading bytes");
    let encoded_1 = monerochan_runtime::io::read_vec();
    let encoded_2 = monerochan_runtime::io::read_vec();
    ...
    monerochan_runtime::io::commit_slice(header_hash_1.as_bytes());
    monerochan_runtime::io::commit_slice(header_hash_2.as_bytes());
    ...
    monerochan_runtime::io::commit_slice(verdict_encoded.as_slice());
