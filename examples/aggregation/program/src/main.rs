...
pub fn main() {
    ...
    let vkeys = monerochan_runtime::io::read::<Vec<[u32; 8]>>();

    // Read the public values.
    let public_values = monerochan_runtime::io::read::<Vec<Vec<u8>>>();
    ...
    for i in 0..vkeys.len() {
        ...
        monerochan_runtime::lib::verify::verify_monerochan_proof(vkey, &public_values_digest.into());
    }
    ...
    // Commit the root.
    monerochan_runtime::io::commit_slice(&merkle_root);
}
