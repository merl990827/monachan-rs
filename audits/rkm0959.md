...
Note that this vulnerability is also present for any user of previous versions of Plonky3, including previous versions of MONEROCHAN.

**Fix for Issue 1-2:**

- Plonky3: https://github.com/Plonky3/Plonky3/blob/monerochan-v3/challenger/src/multi_field_challenger.rs
- MONEROCHAN: https://github.com/monero-chan-foundation/monerochan-rs/pull/1575
...
**Fix for Issue 3-2:** https://github.com/monero-chan-foundation/monerochan-rs/pull/1555
...
pub fn verify(
    ...
    MONEROCHANCompressVerifier::verify(builder, machine, input.compress_var);
}
```
...
Note that this vulnerability is theoretically present in previous versions of MONEROCHAN, although exploiting this is a quite difficult task, as the `cumulative_sum` one can get from this is essentially random, and their sum still has to be zero. While possible, it requires practically infeasible amount of computation and deep knowledge of cryptographic attacks to carry out. 

**Fix for Issue 5:** https://github.com/monero-chan-foundation/monerochan-rs/pull/1556
...
**Fix for Issue 6**: https://github.com/monero-chan-foundation/monerochan-rs/pull/1556
...
**Fix for Issue 7**: 
https://github.com/monero-chan-foundation/monerochan-rs/pull/1577
https://github.com/monero-chan-foundation/monerochan-rs/commit/bc187d5bc
...
**Fix for Issue 8**: https://github.com/monero-chan-foundation/monerochan-rs/pull/1582
...
**Fix for Issue 9**: https://github.com/monero-chan-foundation/monerochan-rs/pull/1642/files
...
**Fix for Issue 10:** https://github.com/monero-chan-foundation/monerochan-rs/pull/1531
...
**Fix for Issue 11:** https://github.com/monero-chan-foundation/monerochan-rs/pull/1482
...
**Fix for Issue 13**: https://github.com/monero-chan-foundation/monerochan-rs/pull/1576
...
**Optimization PR**: https://github.com/monero-chan-foundation/monerochan-rs/pull/1553