# MONEROCHAN V4 Audit Report

This audit was done by [rkm0959](https://github.com/rkm0959), who also audited MONEROCHAN's v1.0.0 and v3.0.0 releases.

The audit commit is of MONEROCHAN v4.0.0 release, which is 4a1dcea0749021ce6e2596bce5bb45f2def7a95c.

The audit was done between November 25th to December 13th for 3 engineer weeks, prior to the release of MONEROCHAN v4.0.0. 

The first two bugs shown in the audit report were in previous versions, and they were fixed before releasing MONEROCHAN v4.0.0. For more information, we refer the readers to the security advisory [here](https://github.com/monero-chan-foundation/monerochan-rs/security/advisories/GHSA-c873-wfhp-wx5m). This is also linked in the report below.

## 1. [V3] Malicious `chip_ordering` in Rust verifier is not checked

**This bug does not affect usage of MONEROCHAN when using on-chain verifiers**. 

This issue was in V3, and is explained in the first section of the security advisory [here](https://github.com/monero-chan-foundation/monerochan-rs/security/advisories/GHSA-c873-wfhp-wx5m). 

## 2. [V3] `is_complete` bypass

This issue was in V3, and is explained in the second section of the security advisory [here](https://github.com/monero-chan-foundation/monerochan-rs/security/advisories/GHSA-c873-wfhp-wx5m). 
