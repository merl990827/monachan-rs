...
//!
//! A client for interacting with the prover for the MONEROCHAN RISC-V zkVM.
...
/// An entrypoint for interacting with the prover for the MONEROCHAN RISC-V zkVM.
///
...
impl ProverClient {
    ...
    ///
    /// std::env::set_var("MONEROCHAN_PROVER", "network");
