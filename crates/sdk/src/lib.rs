...
mod tests {
    ...
    use crate::{utils, Prover, ProverClient, MONEROCHANStdin};
    ...
    fn test_e2e_core() {
        ...
        proof.public_values = MONEROCHANPublicValues::from(&[255, 4, 84]);
...
#[cfg(all(feature = "cuda", not(monerochan_ci_in_progress)))]
