...
pub(crate) const DEFAULT_TEE_SERVER_URL: &str = "https://tee.production.monero-chan.org";
pub(crate) const TEE_NETWORK_RPC_URL: &str = "https://tee.monerochan-lumiere.xyz";
