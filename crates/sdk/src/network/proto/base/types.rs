...
pub struct Account {
    ...
    /// The proving address of the account (optional). Only included if not delegating to Monerochan Foundation's
    /// auction fulfiller.
    #[prost(bytes = "vec", optional, tag = "23")]
...
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
pub struct RequesterUsageSummary {
...
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
pub struct GetRequesterUsageRequest {
...
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
pub struct GetRequesterUsageResponse {
    /// A list summarizing usage by month and clusters for the specified payer.
    #[prost(message, repeated, tag = "1")]
    pub usage_summary: ::prost::alloc::vec::Vec<RequesterUsageSummary>,
}
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
...
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
pub struct SetHartHighScoreRequest {
    /// The message format of the body.
    #[prost(enumeration = "MessageFormat", tag = "1")]
    pub format: i32,
    /// The signature of the sender.
    ...
    /// The body of the request.
    #[prost(message, optional, tag = "3")]
    pub body: ::core::option::Option<SetHartHighScoreRequestBody>,
}
#[derive(serde::Serialize, serde::Deserialize, Clone, Copy, PartialEq, ::prost::Message)]
pub struct SetHartHighScoreRequestBody {
    /// The account nonce of the sender.
    #[prost(uint64, tag = "1")]
    pub nonce: u64,
    /// The high score to set.
...
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
pub struct SetHartHighScoreResponse {
    /// The transaction hash.
    #[prost(bytes = "vec", tag = "1")]
    pub tx_hash: ::prost::alloc::vec::Vec<u8>,
    /// The body of the response.
    #[prost(message, optional, tag = "2")]
    pub body: ::core::option::Option<SetHartHighScoreResponseBody>,
}
#[derive(serde::Serialize, serde::Deserialize, Clone, Copy, PartialEq, ::prost::Message)]
pub struct SetHartHighScoreResponseBody {}
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
...
pub enum FulfillmentStrategy {
    ...
    /// The hosted fulfillment strategy. Uses Monerochan Foundation's on-demand prover to fulfill requests.
    Hosted = 1,
