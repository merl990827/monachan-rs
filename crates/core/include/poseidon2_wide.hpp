...
namespace monerochan_recursion_core_sys::poseidon2_wide {
using namespace constants;
using namespace poseidon2;

template <class F>
__MONEROCHAN_HOSTDEV__ __MONEROCHAN_INLINE__ void populate_external_round(
...
template <class F>
__MONEROCHAN_HOSTDEV__ __MONEROCHAN_INLINE__ void populate_internal_rounds(
...
template <class F>
__MONEROCHAN_HOSTDEV__ __MONEROCHAN_INLINE__ void populate_perm(
...
template <class F>
__MONEROCHAN_HOSTDEV__ void event_to_row(const F input[WIDTH], F* input_row,
...
template <class F>
__MONEROCHAN_HOSTDEV__ void instr_to_row(const Poseidon2SkinnyInstr<F>& instr,
