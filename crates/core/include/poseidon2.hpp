...
namespace monerochan_recursion_core_sys::poseidon2 {
...
template <class F>
__MONEROCHAN_HOSTDEV__ __MONEROCHAN_INLINE__ void mdsLightPermutation4x4(F state[4]) {
...
template <class F>
__MONEROCHAN_HOSTDEV__ __MONEROCHAN_INLINE__ void external_linear_layer(
...
template <class F>
__MONEROCHAN_HOSTDEV__ __MONEROCHAN_INLINE__ void internal_linear_layer(
