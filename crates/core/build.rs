...
const LIB_NAME: &str = "monerochan-recursion-core-sys";
    ...
    pub fn build_ffi() {
        ...
        match cbindgen::Builder::new()
            ...
            .with_parse_include(&[
                ...
                "p3-baby-bear",
                "monerochan-core-executor",
            ])
            .with_parse_extra_bindings(&["monerochan-stark", "monerochan-primitives", "p3-baby-bear"])
            ...
            .with_namespace("monerochan_recursion_core_sys")
        ...
        println!("cargo::rustc-link-lib=static=monerochan-core-machine-sys");
        let include_dir = env::var("DEP_MONEROCHAN_CORE_MACHINE_SYS_INCLUDE").unwrap();
