...
use monerochan_core_executor::events::MemoryAccessPosition;

impl CpuChip {
    /// Computes whether the opcode is a branch instruction.
    pub(crate) fn eval_registers<AB: MONEROCHANAirBuilder>(
        &self,
        builder: &mut AB,
        ...
        // SAFETY: If it's a branch or a store, `op_a_immutable` will be checked to be `1` in the
        // opcode specific chip.
        builder
