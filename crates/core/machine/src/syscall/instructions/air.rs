...
use monerochan_stark::{
    air::{
        BaseAirBuilder, InteractionScope, PublicValues, MONEROCHANAirBuilder, POSEIDON_NUM_WORDS,
        PV_DIGEST_NUM_WORDS, MONEROCHAN_PROOF_NUM_PV_ELTS,
    },
    Word,
};
    ...
    AB::Var: Sized,
{
    ...
    fn eval(&self, builder: &mut AB) {
        ...
        let public_values_slice: [AB::PublicVar; MONEROCHAN_PROOF_NUM_PV_ELTS] =
...
impl SyscallInstrsChip {
    ...
    pub(crate) fn eval_ecall<AB: MONEROCHANAirBuilder>(
        &self,
        builder: &mut AB,
    ...
    pub(crate) fn eval_commit<AB: MONEROCHANAirBuilder>(
        &self,
        builder: &mut AB,
        local: &SyscallInstrColumns<AB::Var>,
    ...
    pub(crate) fn eval_halt_unimpl<AB: MONEROCHANAirBuilder>(
        &self,
        builder: &mut AB,
        local: &SyscallInstrColumns<AB::Var>,
    ...
    pub(crate) fn eval_is_halt_syscall<AB: MONEROCHANAirBuilder>(
        &self,
        builder: &mut AB,
        local: &SyscallInstrColumns<AB::Var>,
    ) {
    ...
    pub(crate) fn get_is_commit_related_syscall<AB: MONEROCHANAirBuilder>(
        &self,
        builder: &mut AB,
        local: &SyscallInstrColumns<AB::Var>,
    ) -> (AB::Expr, AB::Expr) {
    ...
    pub(crate) fn get_num_extra_ecall_cycles<AB: MONEROCHANAirBuilder>(
        &self,
        local: &SyscallInstrColumns<AB::Var>,
    ) -> AB::Expr {
        // The syscall code is the read-in value of op_a at the start of the instruction.
