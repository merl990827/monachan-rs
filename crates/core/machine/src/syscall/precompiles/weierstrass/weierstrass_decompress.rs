...
use monerochan_stark::air::{BaseAirBuilder, InteractionScope, MachineAir, Polynomial, MONEROCHANAirBuilder};
...
mod tests {
    ...
    fn test_weierstrass_bls_decompress() {
        ...
        for _ in 0..num_tests {
            ...
            let stdin = MONEROCHANStdin::from(&compressed);
    ...
    fn test_weierstrass_k256_decompress() {
        ...
        for _ in 0..num_tests {
            ...
            let inputs = MONEROCHANStdin::from(&compressed);
