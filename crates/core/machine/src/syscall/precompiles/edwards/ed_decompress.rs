...
use monerochan_stark::air::{BaseAirBuilder, InteractionScope, MachineAir, MONEROCHANAirBuilder};
use typenum::U32;
...
impl<V: Copy> EdDecompressCols<V> {
    pub fn eval<AB: MONEROCHANAirBuilder<Var = V>, P: FieldParameters, E: EdwardsParameters>(
        &self,
        builder: &mut AB,
    ) where
        V: Into<AB::Expr>,
