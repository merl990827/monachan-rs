...
use monerochan_core_executor::{Opcode, DEFAULT_PC_INC, UNUSED_PC};
    ...
    AB::Var: Sized,
{
    ...
    fn eval(&self, builder: &mut AB) {
        ...
        // Combined with the `op_a_value = pc + 4` check above when `op_a_0 = 0`, this fully
        // constrains `op_a_value`.
