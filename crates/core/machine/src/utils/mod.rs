...
use p3_field::Field;
pub use prove::*;
use monerochan_curves::params::Limbs;
pub use span::*;
pub use test::*;
pub use uni_stark::*;
...
pub use monerochan_primitives::consts::{
...
/// Returns whether the `MONEROCHAN_DEBUG` environment variable is enabled or disabled.
///
...
pub fn monerochan_debug_mode() -> bool {
    let value = std::env::var("MONEROCHAN_DEBUG").unwrap_or_else(|_| "false".to_string());
