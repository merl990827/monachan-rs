...
use monerochan_stark::{
    air::{
        AirInteraction, BaseAirBuilder, InteractionScope, MachineAir, PublicValues, MONEROCHANAirBuilder,
        MONEROCHAN_PROOF_NUM_PV_ELTS,
    },
    ...
    AB: MONEROCHANAirBuilder,
{
    fn eval(&self, builder: &mut AB) {
        ...
        let public_values_array: [AB::Expr; MONEROCHAN_PROOF_NUM_PV_ELTS] =
