...
use monerochan_core_executor::{events::GlobalInteractionEvent, ExecutionRecord, Program};
use monerochan_derive::AlignedBorrow;
use monerochan_stark::{
    air::{AirInteraction, InteractionScope, MachineAir, MONEROCHANAirBuilder},
...
mod tests {
    ...
    use monerochan_core_executor::{ExecutionRecord, Executor};
    use monerochan_stark::{
        air::{InteractionScope, MachineAir},
        baby_bear_poseidon2::BabyBearPoseidon2,
        debug_interactions_with_all_chips, InteractionKind, MONEROCHANCoreOpts, StarkMachine,
    };
    ...
    fn get_test_execution_record() -> ExecutionRecord {
        ...
        use monerochan_core_executor::events::{MemoryLocalEvent, MemoryRecord};
