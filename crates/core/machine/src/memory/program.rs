...
use monerochan_stark::{
    air::{
        AirInteraction, InteractionScope, MachineAir, PublicValues, MONEROCHANAirBuilder,
...
where
    AB: MONEROCHANAirBuilder + PairBuilder + AirBuilderWithPublicValues,
{
    fn eval(&self, builder: &mut AB) {
        ...
        let public_values_slice: [AB::Expr; MONEROCHAN_PROOF_NUM_PV_ELTS] =
