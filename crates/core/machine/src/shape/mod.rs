...
use monerochan_core_executor::{ExecutionRecord, Instruction, Opcode, Program, RiscvAirId};
...
pub mod tests {
    ...
    use monerochan_stark::{Dom, MachineProver, StarkGenericConfig};
    ...
    fn test_dummy_record() {
        ...
        use p3_baby_bear::BabyBear;
        use monerochan_stark::{baby_bear_poseidon2::BabyBearPoseidon2, CpuProver};
