...
// namespace monerochan_core_machine_sys::memory {
// __MONEROCHAN_HOSTDEV__ __MONEROCHAN_INLINE__ uint32_t unwrap_value(const OptionMemoryRecordEnum& record) {
//     switch (record.tag) {
...
// template<class F>
// __MONEROCHAN_HOSTDEV__ void populate_access(
...
// template<class F>
// __MONEROCHAN_HOSTDEV__ void populate_read_write(
