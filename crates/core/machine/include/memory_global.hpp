...
namespace monerochan_core_machine_sys::memory_global {
    template<class F, class EF7>
    __MONEROCHAN_HOSTDEV__ void event_to_row(const MemoryInitializeFinalizeEvent* event, const bool is_receive, MemoryInitCols<F>* cols) {
...
}  // namespace monerochan::memory_local