...
namespace monerochan_core_machine_sys::sll {
template<class F>
__MONEROCHAN_HOSTDEV__ void event_to_row(const AluEvent& event, ShiftLeftCols<decltype(F::val)>& cols) {
