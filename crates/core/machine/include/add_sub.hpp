...
namespace monerochan_core_machine_sys::add_sub {
template<class F>
...
template<class F>
__MONEROCHAN_HOSTDEV__ void event_to_row(const AluEvent& event, AddSubCols<F>& cols) {
