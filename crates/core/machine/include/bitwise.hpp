...
namespace monerochan_core_machine_sys::bitwise {
template<class F>
__MONEROCHAN_HOSTDEV__ void event_to_row(const AluEvent& event, BitwiseCols<F>& cols) {
