...
namespace monerochan_core_machine_sys::syscall {
    template<class F, class EF7>
    __MONEROCHAN_HOSTDEV__ void event_to_row(const SyscallEvent* event, const bool is_receive, SyscallCols<F>* cols) {
