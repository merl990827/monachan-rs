...
namespace monerochan_core_machine_sys::mul {
template<class F>
__MONEROCHAN_HOSTDEV__ void event_to_row(const AluEvent& event, MulCols<decltype(F::val)>& cols) {
