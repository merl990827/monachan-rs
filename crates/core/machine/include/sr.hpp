...
namespace monerochan_core_machine_sys::sr {
template<class F>
__MONEROCHAN_HOSTDEV__ void event_to_row(const AluEvent& event, ShiftRightCols<decltype(F::val)>& cols) {
