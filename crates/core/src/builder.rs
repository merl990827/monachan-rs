...
/// A trait which contains all helper methods for building MONEROCHAN recursion machine AIRs.
pub trait MONEROCHANRecursionAirBuilder: MachineAirBuilder + RecursionAirBuilder {}

impl<AB: AirBuilderWithPublicValues + RecursionAirBuilder> MONEROCHANRecursionAirBuilder for AB {}
