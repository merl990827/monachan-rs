...
use crate::{builder::MONEROCHANRecursionAirBuilder, chips::poseidon2_skinny::columns::Poseidon2};
...
impl<const DEGREE: usize> Poseidon2SkinnyChip<DEGREE> {
    fn eval_input_round<AB: MONEROCHANRecursionAirBuilder>(
        &self,
        builder: &mut AB,
    ...
    fn eval_external_round<AB: MONEROCHANRecursionAirBuilder>(
        &self,
        builder: &mut AB,
        local_row: &Poseidon2<AB::Var>,
        prep_local: &Poseidon2PreprocessedCols<AB::Var>,
    ...
    fn eval_internal_rounds<AB: MONEROCHANRecursionAirBuilder>(
        &self,
        builder: &mut AB,
        local_row: &Poseidon2<AB::Var>,
        next_row: &Poseidon2<AB::Var>,
