...
use crate::{builder::MONEROCHANRecursionAirBuilder, runtime::ExecutionRecord};
use core::borrow::Borrow;
use p3_air::{Air, AirBuilder, BaseAir, PairBuilder};
use p3_field::{AbstractField, PrimeField32};
use p3_matrix::{dense::RowMajorMatrix, Matrix};
use monerochan_derive::AlignedBorrow;
use monerochan_stark::air::{BaseAirBuilder, ExtensionAirBuilder, MachineAir, MONEROCHANAirBuilder};
...
impl<const DEGREE: usize> ExpReverseBitsLenChip<DEGREE> {
    pub fn eval_exp_reverse_bits_len<
        AB: BaseAirBuilder + ExtensionAirBuilder + MONEROCHANRecursionAirBuilder + MONEROCHANAirBuilder,
    >(
        &self,
        builder: &mut AB,
