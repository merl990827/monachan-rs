...
use monerochan_core_machine::utils::indices_arr;
use monerochan_derive::AlignedBorrow;
use monerochan_stark::{air::POSEIDON_NUM_WORDS, septic_digest::SepticDigest, Word, PROOF_MAX_NUM_PVS};
...
// monerochan_core should be set to `RECURSIVE_PROOF_NUM_PV_ELTS`.
...
pub struct RecursionPublicValues<T> {
    ...
    /// The commitment to the monerochan program being proven.
    pub monerochan_vk_digest: [T; DIGEST_SIZE],
