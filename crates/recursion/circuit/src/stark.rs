...
use monerochan_stark::septic_digest::SepticDigest;

/// Reference: [monerochan_core::stark::ShardProof]
...
pub mod tests {
    ...
    use monerochan_core_executor::MONEROCHANContext;
    use monerochan_recursion_core::{air::Block, machine::RecursionAir, stark::BabyBearPoseidon2Outer};
    use monerochan_stark::{
        baby_bear_poseidon2::BabyBearPoseidon2, CpuProver, InnerVal, MachineProver, MONEROCHANCoreOpts,
        ShardProof,
    };
