...
use super::{assert_complete, MONEROCHANCompressWitnessVariable};

/// A program that recursively verifies a proof made by [super::MONEROCHANRootVerifier].
#[derive(Debug, Clone, Copy)]
pub struct MONEROCHANWrapVerifier<C, SC, A> {
    _phantom: PhantomData<(C, SC, A)>,
}

impl<C, SC, A> MONEROCHANWrapVerifier<C, SC, A>
where
